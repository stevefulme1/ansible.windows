# Contributing to ansible.windows

Thank you for your interest in contributing to **ansible.windows**!
...
```bash
git clone https://github.com/stevefulme1/ansible.windows.git
cd ansible.windows
```
